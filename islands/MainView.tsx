  ...
  return (
    <div className="main-view-container">
      <div className="view-toggle">
        {/*Se agrega un evento onClick para cambiar el estado */}
        <button
          type="button"
          ...
          onClick={() => isGrid.value = !isGrid.value} // Corrige el cambio de estado
        >
          {isGrid.value ? "Lista" : "Cuadrícula"}
        </button>
      </div>

      <div
        className={`posts-container ${isGrid.value ? "grid-view" : "list-view"}`}
      >
        {posts.map((post) => (
